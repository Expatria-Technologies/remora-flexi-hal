...
class TMC2130Stepper : public TMCStepper {
	public:
		TMC2130Stepper(const std::string& pinCS, const std::string& pinMOSI, const std::string& pinMISO, const std::string& pinSCK, int8_t link = -1);
		TMC2130Stepper(const std::string& pinCS, float RS, const std::string& pinMOSI, const std::string& pinMISO, const std::string& pinSCK, int8_t link = -1);
		void begin();
		void defaults();
...
class TMC2160Stepper : public TMC2130Stepper {
	public:
		...
		TMC2160Stepper(const std::string& pinCS, const std::string& pinMOSI, const std::string& pinMISO, const std::string& pinSCK, int8_t link = -1);
		TMC2160Stepper(const std::string& pinCS, float RS, const std::string& pinMOSI, const std::string& pinMISO, const std::string& pinSCK, int8_t link = -1);
		void begin();
		void defaults();
		void push();
...
class TMC5130Stepper : public TMC2160Stepper {
	public:
		TMC5130Stepper(const std::string& pinCS, const std::string& pinMOSI, const std::string& pinMISO, const std::string& pinSCK, int8_t link = -1);
		TMC5130Stepper(const std::string& pinCS, float RS, const std::string& pinMOSI, const std::string& pinMISO, const std::string& pinSCK, int8_t link = -1);
		void begin();
		void defaults();
		void push();
...
class TMC5160Stepper : public TMC5130Stepper {
	public:
		...
		TMC5160Stepper(const std::string& pinCS, const std::string& pinMOSI, const std::string& pinMISO, const std::string& pinSCK, int8_t link = -1);
		TMC5160Stepper(const std::string& pinCS, float RS, const std::string& pinMOSI, const std::string& pinMISO, const std::string& pinSCK, int8_t link = -1);
